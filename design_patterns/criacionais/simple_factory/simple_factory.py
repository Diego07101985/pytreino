...
class Veiculo(ABC):
    @abstractmethod
    def buscar_client(self) -> None: pass


class CarroLuxo(Veiculo):
    def buscar_client(self) -> None:
        print('Carro de Luxo de um cliente ...')


class CarroPopular(Veiculo):
    def buscar_client(self) -> None:
        print('Carro Popular de um cliente ...')


class Moto(Veiculo):
    def buscar_client(self) -> None:
        print('Moto Popular de um cliente ...')
